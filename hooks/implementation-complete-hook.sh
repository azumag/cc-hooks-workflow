#!/bin/bash
# Implementation Complete Hook
# IMPLEMENTATION_COMPLETED状態で呼び出されるhookスクリプト
...
# Implementation complete処理（実装完了後の処理をここに実装）
echo '{"decision": "approve", "reason": "Implementation completed successfully"}'
exit 0